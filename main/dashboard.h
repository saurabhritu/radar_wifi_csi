...
"    <div class=\"hud-item\"><span class=\"hud-label\">SUBCARRIERS</span>"
"      <span class=\"hud-value\" id=\"hud-sc\">—</span></div>"
"  </div>"
"</div>"
...
"  sv.textContent = isMotion ? 'MOTION DETECTED' : 'CLEAR';"
"  sv.className   = isMotion ? 'motion' : 'clear';"
"  document.getElementById('hud-var').textContent  = varFmt;"
"  document.getElementById('hud-sc').textContent   = d.subcarriers || 64;"
...
"    ctx.fillStyle = 'rgba(255,45,85,'+Math.min(b.life,1)+')';"
